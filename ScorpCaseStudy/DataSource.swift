...
public class DataSource {
    ...
    private struct Constants {
        static let peopleCountRange: ClosedRange<Int> = 30...40 // lower bound must be > 0
        static let fetchCountRange: ClosedRange<Int> = 10...15 // lower bound must be > 0
        ...
        static let backendBugTriggerProbability = 0.1 // must be > 0.0
